...
nonisolated enum AgentNotifyScript {
    ...
    export SKILLZ_PLATFORM="$platform" SKILLZ_STATE="$state" SKILLZ_SESSION_ID="$session_id"
    export SKILLZ_TITLE="$title" SKILLZ_CWD="$cwd" SKILLZ_PID="$pid"
    export SKILLZ_STATE_FILE="$STATE_FILE" SKILLZ_HOOK_INPUT_FILE="$input_file"
